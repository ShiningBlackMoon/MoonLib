package stars.astral.moonlib.schematic;
...
public class Schematic {
    ...
    public void paste(World world, Location origin, boolean withScan) throws IOException {
        ...
        try {
            ...
            int xOffset = offsets.getInt("WEOffsetX", 0);
            int yOffset = offsets.getInt("WEOffsetY", 0);
            int zOffset = offsets.getInt("WEOffsetZ", 0);
